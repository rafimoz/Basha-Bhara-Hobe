    ...
    return (
        <div className="min-h-screen dark:bg-bg-dark bg-bg-light">
                    ...
                    <div className="grid lg:grid-cols-2 gap-12 items-center">
                        <div className="space-y-8">
                            <div className="space-y-4">
                                <h1 className="text-5xl lg:text-6xl font-bold dark:text-title-dark text-title-light leading-tight">
                                    Rent Smarter.
                                    <span className="dark:text-subtitle-dark text-subtitle-light/50"> Just Scan.</span>
                                </h1>
                                <p className="text-xl dark:text-description-dark text-description-light leading-relaxed">
            ...
            <section id="how-it-works" className="py-20">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="text-center mb-16">
                        <h2 className="text-4xl font-bold dark:text-title-dark text-title-light mb-4">How It Works</h2>
                        <p className="text-xl dark:text-subtitle-dark text-subtitle-light">Four simple steps to revolutionize your rental experience</p>
                    </div>
                    <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
                        {[
                            ...
                            >
                                <div className="dark:text-title-dark text-title-light/70 text-6xl font-bold mb-4">{item.step}</div>
            ...
            <section id="features" className="py-20">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="text-center mb-16">
                        <h2 className="text-4xl font-bold dark:text-title-dark text-title-light mb-4">Why Choose Basha Bhara Hobe?</h2>
                        <p className="text-xl dark:text-subtitle-dark text-subtitle-light">Modern solutions for traditional rental problems</p>
                    </div>
            ...
            <section className="py-20">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="text-center mb-16">
                        <h2 className="text-4xl font-bold dark:text-title-dark text-title-light mb-4">See It In Action</h2>
                        <p className="text-xl dark:text-subtitle-dark text-subtitle-light">Experience the platform through our interactive demo</p>
                    </div>
            ...
            <section id="about" className="py-20">
                <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                    <h2 className="text-4xl font-bold dark:text-title-dark text-title-light mb-8">About Basha Bhara Hobe</h2>
                    <div className="space-y-6 text-lg dark:text-subtitle-dark text-subtitle-light leading-relaxed">
                        <p>
                    ...
                    <div className="mt-12 grid md:grid-cols-4 gap-8 text-center">
                        <div>
                            <div className="text-3xl font-bold dark:text-subtitle-dark text-subtitle-light">MERN</div>
                            <div className="dark:text-description-dark text-description-light">Stack Technology</div>
                        </div>
                        <div>
                            <div className="text-3xl font-bold dark:text-subtitle-dark text-subtitle-light">QR</div>
                            <div className="dark:text-description-dark text-description-light">Code Innovation</div>
                        </div>
                        <div>
                            <div className="text-3xl font-bold dark:text-subtitle-dark text-subtitle-light">0</div>
                            <div className="dark:text-description-dark text-description-light">Agent Fees</div>
                        </div>
                        <div>
                            <div className="text-3xl font-bold dark:text-subtitle-dark text-subtitle-light">24/7</div>
                            <div className="dark:text-description-dark text-description-light">Availability</div>
                        </div>
                    </div>
                </div>
            </section>
            ...
            <section className="py-20 dark:bg-nav-dark bg-nav-light">
                <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                    <h2 className="text-4xl font-bold dark:text-title-dark text-title-light mb-6">Start Listing Your Apartment Today</h2>
                    <p className="text-xl dark:text-subtitle-dark text-subtitle-light mb-8">
