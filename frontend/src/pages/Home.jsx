...
const HomePage = () => {
    ...
    return (
        <div className="min-h-screen bg-bg-dark">
            {/* Nav Section */}
            <nav className="fixed top-0 w-full bg-nav-dark backdrop-blur-sm z-50">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="flex justify-between items-center h-16">
                        <div className="flex items-center gap-2">
                            ...
                            <span className="text-xl font-bold text-subtitle-dark">Basha Bhara Hobe</span>
                        </div>

                        {/* Desktop Navigation Links */}
                        <div className="hidden md:flex items-center space-x-8">
                            <a href="#how-it-works" className="text-subtitle-dark hover:text-subtitle-dark/60 transition-colors">How It Works</a>
                            <a href="#features" className="text-subtitle-dark hover:text-subtitle-dark/60 transition-colors">Features</a>
                            <a href="#about" className="text-subtitle-dark hover:text-subtitle-dark/60 transition-colors">About</a>
                            <button onClick={() => navigate("/login")} className="bg-subtitle-dark text-white px-6 py-2 rounded-lg hover:bg-teal-700 transition-colors">
                                Get Started
                            </button>
                        </div>
                        ...
                        <div className="md:hidden flex items-center">
                            <button
                                ...
                                className="text-subtitle-dark hover:text-subtitle-dark/50 focus:outline-none focus:text-subtitle-dark"
                            >
                                <svg
                                    className="h-6 w-6"
                                    stroke="currentColor"
                ...
                >
                    <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
                        <a
                            href="#how-it-works"
                            className="block px-3 py-2 rounded-md text-base font-medium text-subtitle-dark hover:text-subtitle-light hover:bg-subtitle-dark"
                        ...
                        <button onClick={() => navigate("/login")} className="w-full text-left bg-subtitle-dark text-white px-3 py-2 rounded-md text-base font-medium hover:bg-subtitle-dark/60 transition-colors mt-2">
                            Get Started
                        </button>
                    </div>
                </div>
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="grid lg:grid-cols-2 gap-12 items-center">
                        <div className="space-y-8">
                            <div className="space-y-4">
                                <h1 className="text-5xl lg:text-6xl font-bold text-title-dark leading-tight">
                                    Rent Smarter.
                                    <span className="text-subtitle-dark"> Just Scan.</span>
                                </h1>
                                <p className="text-xl text-description-dark leading-relaxed">
                            ...
                            <div className="flex flex-col sm:flex-row gap-4">
                                <button onClick={() => { navigate("/register") }} className="bg-cta-dark text-white px-8 py-4 rounded-lg text-lg font-semibold hover:bg-teal-700 transform hover:scale-105 transition-all duration-200 flex items-center justify-center">
                                    Post Your Property
                  ...
                  Find a Rental
                        ...
                        <div className="relative">
                            <div className="bg-gradient-to-r from-subtitle-dark/30 to-card-dark rounded-3xl p-8 transform rotate-3 hover:rotate-0 transition-transform duration-300">
            ...
            {/* How It Works */}
            <section id="how-it-works" className="py-20 bg-bg-dark">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="text-center mb-16">
                        <h2 className="text-4xl font-bold text-title-dark mb-4">How It Works</h2>
                        <p className="text-xl text-subtitle-dark">Four simple steps to revolutionize your rental experience</p>
                    </div>
                    <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
                        {[
                            ...
                            <div
                                key={index}
                                id={`step-${index}`}
                                className={`bg-card-dark rounded-2xl p-8 text-center transform transition-all duration-700 hover:scale-105 ${isVisible[`step-${index}`] ? 'translate-y-0 opacity-100' : 'translate-y-8 opacity-0'
                                    }`}
                                style={{ transitionDelay: `${index * 150}ms` }}
                            >
                                <div className="text-title-dark text-6xl font-bold mb-4">{item.step}</div>
                                <div className="w-16 h-16 bg-title-dark rounded-2xl flex items-center justify-center mx-auto mb-6">
                                    <item.icon className="h-8 w-8 text-bg-dark" />
                                </div>
                                <h3 className="text-xl font-semibold text-subtitle-dark mb-3">{item.title}</h3>
                                <p className="text-description-dark">{item.description}</p>
                            </div>
                        ))}
                    </div>
                </div>
            ...
            <section id="features" className="py-20">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="text-center mb-16">
                        <h2 className="text-4xl font-bold text-title-dark mb-4">Why Choose Basha Bhara Hobe?</h2>
                        <p className="text-xl text-subtitle-dark">Modern solutions for traditional rental problems</p>
                    </div>
                    <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                        {[
                            ...
                            <div
                                key={index}
                                className="bg-card-dark p-8 rounded-2xl shadow-lg hover:shadow-xl transition-shadow duration-300 border border-title-dark/30"
                            >
                                <div className="w-14 h-14 bg-title-dark rounded-xl flex items-center justify-center mb-6">
                                    <feature.icon className="h-7 w-7 text-bg-dark" />
                                </div>
                                <h3 className="text-xl font-semibold text-title-dark mb-3">{feature.title}</h3>
                                <p className="text-subtitle-dark">{feature.description}</p>
                            </div>
                        ))}
                    </div>
                </div>
            ...
            <section className="py-20 bg-bg-dark">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="text-center mb-16">
                        <h2 className="text-4xl font-bold text-title-dark mb-4">See It In Action</h2>
                        <p className="text-xl text-subtitle-dark">Experience the platform through our interactive demo</p>
                    </div>
                    <div className="relative max-w-4xl mx-auto">
                        <div className="bg-card-dark rounded-3xl shadow-2xl overflow-hidden h-118">
                            {showVideo ? (
                                // Video Element
                                ...
                                <div className="relative h-96 bg-gradient-to-br from-card-dark to-title-dark/50 flex items-center justify-center">
                                    <div className="text-center text-white space-y-4">
                                        <div className="w-20 h-20 bg-title-dark/90 text-bg-dark/80 rounded-2xl flex items-center justify-center mx-auto">
                            ...
                            {!showVideo && ( // Only show controls if video is not playing
                                ...
                                <div className="p-6">
                                    <div className="flex justify-between items-center">
                                        <button onClick={prevSlide} className={`p-2 rounded-full bg-subtitle-dark hover:bg-subtitle-dark/60 transition-colors`}>
                                        ...
                                        <div className="flex space-x-2">
                                            {demoImages.map((_, index) => (
                                                <button
                                                    ...
                                                    className={`w-3 h-3 rounded-full transition-colors ${index === currentSlide ? 'bg-description-dark' : 'bg-title-dark'}`}
                                                />
                                            ))}
                                        </div>
                                        <button onClick={nextSlide} className={`p-2 rounded-full bg-subtitle-dark hover:bg-subtitle-dark/60 transition-colors`}>
                        ...
                        <button
                            ...
                            className="mt-8 mx-auto block bg-cta-dark text-white px-8 py-4 rounded-lg font-semibold hover:bg-cta-dark/70 transition-colors"
                        >
                            Watch Demo Video
                        </button>
                    </div>
            ...
            <section id="about" className="py-20">
                <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                    <h2 className="text-4xl font-bold text-title-dark mb-8">About Basha Bhara Hobe</h2>
                    <div className="space-y-6 text-lg text-subtitle-dark leading-relaxed">
                        <p>
                    ...
                    <div className="mt-12 grid md:grid-cols-4 gap-8 text-center">
                        <div>
                            <div className="text-3xl font-bold text-subtitle-dark">MERN</div>
                            <div className="text-description-dark">Stack Technology</div>
                        </div>
                        <div>
                            <div className="text-3xl font-bold text-subtitle-dark">QR</div>
                            <div className="text-description-dark">Code Innovation</div>
                        </div>
                        <div>
                            <div className="text-3xl font-bold text-subtitle-dark">0</div>
                            <div className="text-description-dark">Agent Fees</div>
                        </div>
                        <div>
                            <div className="text-3xl font-bold text-subtitle-dark">24/7</div>
                            <div className="text-description-dark">Availability</div>
                        </div>
                    </div>
                </div>
            </section>
            ...
            {/* CTA Section */}
            <section className="py-20 bg-nav-dark">
                <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                    <h2 className="text-4xl font-bold text-title-dark mb-6">Start Listing Your Apartment Today</h2>
                    <p className="text-xl text-subtitle-dark mb-8">
                        Join thousands of property owners who have already modernized their rental process
                    </p>
                    <div className="flex flex-col sm:flex-row gap-4 justify-center">
                        <button onClick={() => navigate("/register")} className="bg-cta-dark text-white px-8 py-4 rounded-lg text-lg font-semibold hover:bg-cta-dark/50 transition-colors">
                            Create Account
                        </button>
                        <button className="border-2 border-cta-dark text-cta-dark px-8 py-4 rounded-lg text-lg font-semibold hover:text-white transition-colors">
                            Explore Listings
                        </button>
                    </div>
                </div>
            ...
            {/* Footer */}
            <footer className="bg-bg-dark text-title-dark py-16">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="grid md:grid-cols-4 gap-8">
                        ...
                        <div>
                            ...
                            <div className="space-y-2">
                                <a href="#" className="block text-subtitle-dark hover:text-white transition-colors">About</a>
                                <a href="#" className="block text-subtitle-dark hover:text-white transition-colors">Contact</a>
                                <a href="#" className="block text-subtitle-dark hover:text-white transition-colors">Privacy Policy</a>
                                <a href="#" className="block text-subtitle-dark hover:text-white transition-colors">Terms of Service</a>
                            </div>
                        </div>
                        <div>
                            ...
                            <div className="space-y-3">
                                <div className="flex items-center space-x-3">
                                    <Mail className="h-5 w-5 text-subtitle-dark" />
                                    <span className="text-subtitle-dark">mozumder.rafi1@gmail.com</span>
                                </div>
                            </div>
                        </div>
                        <div>
