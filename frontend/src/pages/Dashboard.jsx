...
const Dashboard = () => {
  ...
  return (
    ...
    <div className="min-h-screen dark:bg-bg-dark bg-bg-light font-sans">
      ...
      {/* Header Section */}
      <header className="dark:bg-nav-dark bg-bg-light shadow-sm py-4 px-6 flex justify-between items-center sticky top-0 z-10">
            ...
            {ads.map((ad) => (
              ...
              >
                <div className="relative">
                  ...
                  <div className="absolute bottom-3 left-1/2 transform -translate-x-1/2 flex gap-2">
                    {ad.images.map((_, index) => (
                      <span
                        key={index}
                        className="w-3 h-3 bg-white rounded-full border dark:border-card-dark border-card-light"
                      />
                    ))}
                  </div>
                </div>
                ...
                <div className="p-5"> {/* Increased internal padding for text */}
                  ...
                  <p className="dark:text-description-dark text-description-light text-base mb-3 line-clamp-3">{ad.description}</p>
                  {/* Move-in Date */}
                  <p className="dark:text-description-dark text-description-light text-sm mb-4">
                  ...
                  <div className={`inline-block px-3 py-1 text-xs font-medium rounded-full text-white ${ad.availability ? 'bg-green-500' : 'bg-red-500'}`}>
                    {ad.availability ? "Available" : "Unavailable"}
                  </div>

                  <div className="flex flex-row justify-center mt-6 gap-5"> {/* Increased gap for buttons */}
                    ...
                    <button
                      ...
                      className="bg-green-500 w-full h-15 p-4 rounded-full hover:bg-green-600 hover:text-white transition"
                    >
                    ...
                    <button
                      ...
                      className="bg-red-500 text-white w-full h-15 p-4 rounded-full hover:bg-red-600 hover:text-white transition"
                    >
